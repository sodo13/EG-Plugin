...
from enigma import eServiceReference, eServiceCenter, eTimer, eSize, eConsoleAppContainer, eListboxPythonMultiContent, gFont, RT_HALIGN_LEFT, RT_HALIGN_RIGHT, RT_HALIGN_CENTER, RT_VALIGN_CENTER, getDesktop
...
class FileCommanderConfigScreen(Screen, ConfigListScreen):
    ...
    def __init__(self, session):
        ...
        Screen.setTitle(self, _('EGAMI FileCommander - Setup'))
        self.list = []
        self.list.append(getConfigListEntry(_('Add File Commnader to Mainmenu'), config.plugins.filecommander.add_mainmenu_entry))
